#!/bin/bash
curl --ssl-revoke-best-effort --retry 2 --connect-timeout 30 --create-dirs --output-dir "expansions" -O https://cdn.jsdelivr.net/gh/salix5/ypk@master/pre-release.ypk
